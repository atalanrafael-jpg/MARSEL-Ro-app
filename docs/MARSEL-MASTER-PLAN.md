# MARSEL ROAPP — MASTER PROJECT PLAN

## 1. Назначение
Единый проект **MARSEL ROAPP** для управления ювелирной студией MARSEL и технологическим контуром ROAPP: операции, каталог, производство, ремонт, часы, склад, продажи, e-commerce, аналитика, автоматизация и контроль качества.
