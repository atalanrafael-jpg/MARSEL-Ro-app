#!/usr/bin/env python3
"""MARSEL V17.2.3 — metadata-only inspection of live GET responses."""
...
OUT = "marsel-live-api-metadata-v17-2-3.json"
if not KEY:
...
def get(url, api=False):
    headers = {
        "User-Agent": "MARSEL-LIVE-AUDIT/17.2.3",
...
print("=== MARSEL AUDIT V17.2.3 / LIVE GET RESPONSE METADATA / READ ONLY ===")
