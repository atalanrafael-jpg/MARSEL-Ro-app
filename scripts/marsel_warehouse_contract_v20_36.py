...
def extract_rows(payload):
    ...
    for row in found:
        ...
        if sig not in signatures:
            signatures.add(sig); unique.append(row)
    return unique
...
def main():
    ...
    contract = {"warehouse_list":{"method":"GET","path":"/v2/warehouse/","source":WAREHOUSE_DOC,"query":{"type":"product"}},"stock":{"method":"GET","path":"/warehouse/goods/{warehouse_id}","source":STOCK_DOC}}
