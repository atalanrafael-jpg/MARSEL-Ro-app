...
- consumer-law wording and warranty periods for each document;
- personal-data notification/consent/legal-basis configuration;
- advertising and e-commerce requirements;
- exact contractual requisites;
