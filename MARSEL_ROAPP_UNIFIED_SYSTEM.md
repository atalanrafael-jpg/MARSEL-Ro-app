...
- Фактически существующая и используемая каноническая ветка: `main-MARSEL-ROAPP`.
- Ветка `main` в репозитории сейчас не создана; её нельзя считать источником истины или обозначать как проверенную.
