...
`main` — единственная каноническая интеграционная ветка. `main-MARSEL-ROAPP` — legacy/default branch до выполнения отдельной административной миграции default branch. Состояния обеих веток должны оставаться идентичными до завершения этой миграции.
